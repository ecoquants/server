...
docker-compose exec pg_tileserv_db sh -c "shp2pgsql -D -s 4326 /work/ne_50m_admin_0_countries/ne_50m_admin_0_countries.shp | psql -U tileserv -d tileserv"

# Load Vancouver Water Hydrants
docker-compose exec pg_tileserv_db sh -c "shp2pgsql -D -s 26910 -I /work/water-hydrants/water-hydrants.shp hydrants | psql -U tileserv -d tileserv"
